...
var processElementMultiplyBg = (function ($) {
    return (function (selector, info) {
        ...
        var path = "";
        var script = $('head script[src*="Estilos/Master01/script.js"]');
        if (script.length) {
        ...
        for (var i = bgimages.length - 1; i >= 0; i--) {
            ...
            if (bgimage === "")
                continue;
            var imgIdx = bgimage.lastIndexOf('Images/MasterInicial/');
        ...
        return function () {
            ...
            $.each(slides, function (slideIdx, slide) {
                ...
                $.each(bgImage, function (idx, val) {
                    var findImageIdx = val.lastIndexOf('Images/MasterInicial/');
...
jQuery(function ($) {
    ...
    processElementMultiplyBg(".art-header", {
        "bgimage": "url('Images/MasterInicial/header.png')",
        "bgposition": "0 0",
        "images": "",
        "positions": ""
    });
